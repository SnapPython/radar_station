...
bool my_msgss__msg__yolopoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_msgss.msg._yolopoint.Yolopoint", full_classname_dest, 33) == 0);
  }
  my_msgss__msg__Yolopoint * ros_message = _ros_message;
  {  // id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * my_msgss__msg__yolopoint__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Yolopoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_msgss.msg._yolopoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Yolopoint");
  ...
  my_msgss__msg__Yolopoint * ros_message = (my_msgss__msg__Yolopoint *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
